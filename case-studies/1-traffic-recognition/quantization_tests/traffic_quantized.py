...
model.load_weights('h5/traffic-trained-quantized.weights.h5')

_, q_aware_model_accuracy = model.evaluate(
   X_test, y_test, verbose=0)

print('Quant test accuracy:', q_aware_model_accuracy)


#q_aware_model.save_weights('h5/traffic-trained-quantized.weights.h5')
